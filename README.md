...
IT시스템·전산과 소프트웨어 품질을 중심으로, 백엔드와 AI 솔루션 직무까지 지원하고 있습니다.
...
| **[오늘도 신선](https://github.com/crushonyou2/Fridge-D-Day)** | 유통기한 관리 Android 앱. 기획·개발·스토어 배포·운영 단독 | 원스토어 배포 2건 · **독립 한국 라벨 55장 · D-30 시나리오 기준** OCR 정확 일치율 **67.27% → 72.73%** · **잔여 오답을 근거로 배포를 보류한 뒤 원인을 제품 구조로 해결해 재출시** ([QA 기록](https://github.com/crushonyou2/Fridge-D-Day/blob/main/QA_RELEASE_RECORD.md)) |
